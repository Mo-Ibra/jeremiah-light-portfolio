  ...
  return (
    <section className="py-20 px-6 bg-[#5360c226]" id="services">
      <div className="container max-w-[1200px] mx-auto">
        {/* Header */}
        <SectionHeader badgeText="My Services" className="mb-12 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="relative overflow-hidden rounded-3xl h-[390px] group pointer-events-none">
            <div
