    ...
    >
      ...
      >
        <div className="relative w-[180px] h-[240px] md:w-[310px] md:h-[388px] rounded-xl overflow-hidden">
          ...
          {isVisible && (
            <div
              className={`wistia_embed wistia_async_${videoId} plugin_wistiaLogo=false autoPlay=false w-[180px] h-[240px] md:w-[310px] md:h-[388px] transition-opacity duration-500 ease-in-out`}
              // onClick={handleMute}
